...
// Land dots only: [lat, lon, animDur, animDelay]
const RAW_COUNTRIES: [number, number, number, number][] = [
  // Europe
  [64,-22,4.2,0.3],[66,18,3.8,1.4],[65,26,4.5,2.1],[62,10,3.6,0.7],[60,11,4.8,3.2],[59,18,4.1,1.0],
  [62,26,5.0,0.4],[60,25,3.4,2.8],[57,25,4.7,1.6],[56,24,3.9,3.5],[56,10,5.2,0.2],[55,13,4.0,2.0],
  [54,-3,3.7,1.3],[53,-8,4.9,3.8],[52,5,4.3,0.6],[51,4,3.5,2.4],[51,10,5.1,1.9],[50,15,4.6,0.9],
  [47,8,3.8,3.1],[47,2,4.4,1.7],[47,14,5.3,0.1],[48,20,3.6,2.6],[49,32,4.0,1.2],[47,19,5.5,3.4],
  [44,17,4.2,0.5],[44,21,3.9,2.3],[43,25,5.0,1.0],[46,25,4.7,3.7],[41,22,3.4,0.8],[41,20,5.2,2.1],
  [43,19,4.1,1.5],[45,16,3.7,3.0],[46,15,4.8,0.3],[40,-4,5.4,2.7],[39,-8,3.6,1.1],[43,12,4.3,3.6],
  [36,14,5.1,0.6],[39,22,4.6,2.2],[35,33,3.8,1.8],[37,23,5.3,3.3],[40,30,4.0,0.4],[41,29,3.5,2.9],
  [53,28,4.9,1.4],[55,37,4.4,3.8],[57,83,3.7,0.9],[53,107,5.6,2.5],[56,60,4.1,1.3],
  // Asia — Central & West
  [39,35,4.7,0.2],[37,43,3.4,2.8],[42,43,5.5,1.6],[40,45,4.2,3.1],[39,47,3.8,0.7],
  [34,36,5.0,2.0],[33,44,4.3,1.4],[33,53,3.6,3.6],[37,58,4.8,0.5],[35,51,5.2,2.3],
  [29,47,3.9,1.0],[24,45,4.5,3.4],[25,51,3.7,0.8],[24,54,5.1,2.6],[21,57,4.0,1.2],[15,44,4.7,3.9],
  [48,68,3.5,0.3],[41,64,5.3,2.1],[39,71,4.1,1.7],[43,78,4.6,3.3],[34,65,3.8,0.6],[36,68,5.0,2.4],
  // Asia — South
  [30,70,4.4,1.5],[28,77,3.6,0.1],[22,78,5.2,2.9],[13,78,4.0,1.8],[7,81,3.7,3.5],
  [28,84,5.5,0.4],[27,90,4.2,2.7],[24,90,3.4,1.1],[17,96,4.9,3.0],[15,101,3.8,0.9],
  [18,103,5.1,2.5],[16,107,4.3,1.3],[12,105,3.6,3.8],[4,109,4.7,0.7],
  [1,104,5.3,2.0],[-6,107,4.0,1.6],[0,101,3.5,3.2],[4,114,4.8,0.2],[-2,120,5.0,2.8],
  [13,122,4.4,1.0],[8,124,3.7,3.7],[-9,125,5.2,0.5],
  // Asia — East
  [47,107,3.9,1.9],[35,105,4.6,3.4],[39,116,5.4,0.8],[36,112,3.5,2.2],[31,118,4.1,1.4],
  [22,114,4.8,3.0],[25,121,3.3,0.6],[37,128,5.5,2.5],[39,125,4.0,1.7],[35,137,3.8,3.3],[43,141,4.5,0.3],
  [38,127,5.1,2.0],[33,131,4.3,1.0],[31,130,3.6,3.6],[23,120,4.9,0.4],[26,119,3.4,2.1],
  // Africa — North
  [32,-5,5.0,1.6],[28,3,4.3,3.1],[33,9,3.6,0.5],[28,17,5.4,2.3],[27,30,4.8,1.0],[32,13,3.9,3.7],
  [30,31,4.1,0.2],[24,32,5.3,2.6],[16,32,3.7,1.3],[15,38,4.6,3.5],[12,37,5.0,0.8],[8,38,4.2,2.0],
  // Africa — West
  [15,-17,4.1,1.5],[11,-12,3.9,3.2],[8,-12,5.2,0.6],[6,-10,4.5,2.9],[7,-6,3.7,1.1],[8,-1,4.9,3.8],
  [9,2,5.5,0.3],[9,8,4.2,2.4],[12,-2,3.5,1.7],[17,-4,4.7,3.0],[21,-10,5.0,0.9],[14,-14,3.8,2.7],
  // Africa — Central & East
  [4,12,3.8,1.4],[7,18,4.1,3.6],[15,19,5.3,0.2],[17,8,4.6,1.8],[15,30,3.4,3.4],[10,44,5.0,0.7],
  [0,38,4.6,2.1],[-6,35,4.1,1.0],[-3,23,3.6,3.9],[-1,15,5.4,0.5],[0,11,4.3,2.3],
  [2,31,4.0,1.6],[-2,30,4.7,3.2],[10,24,3.5,0.1],[6,26,5.1,2.8],
  // Africa — South
  [-15,35,5.5,1.2],[-14,28,3.9,3.5],[-20,30,4.4,0.8],[-22,25,4.8,2.5],
  [-22,18,3.5,1.0],[-13,18,5.6,3.3],[-29,25,4.7,0.6],[-25,46,3.3,2.0],
  [-34,18,4.9,1.5],[-30,30,4.0,3.8],[-26,28,5.2,0.4],
  // North America
  [70,-95,3.7,1.3],[64,-96,5.0,2.9],[60,-111,4.3,0.7],[56,-106,3.6,3.2],[49,-75,4.9,1.0],
  [49,-123,3.8,2.6],[45,-121,5.4,0.3],[45,-93,4.1,1.9],[42,-83,3.5,3.7],[40,-100,4.7,0.8],
  [37,-80,5.2,2.4],[37,-98,3.9,1.5],[35,-95,4.4,3.0],[33,-84,3.6,0.2],[32,-97,5.1,1.8],
  [29,-90,4.0,3.5],[25,-80,3.7,1.1],[47,-52,4.8,2.7],[44,-76,5.0,0.5],[46,-64,3.4,2.1],
  [19,-99,3.6,3.8],[20,-90,4.2,0.9],[15,-90,5.5,2.4],[9,-80,4.0,1.3],[22,-80,3.8,3.0],
  [18,-72,4.6,0.6],[19,-70,5.3,2.2],[13,-61,3.5,1.7],[18,-67,4.9,3.4],[10,-67,4.1,0.1],
  [63,-152,3.8,2.3],[58,-134,4.5,1.6],[66,-53,3.6,3.1],
  // South America
  [5,-59,5.3,0.8],[4,-73,4.7,2.5],[0,-78,3.8,1.2],[-3,-60,3.5,3.6],[-8,-37,4.8,0.4],
  [-10,-76,5.0,2.0],[-15,-48,4.2,1.4],[-17,-64,3.7,3.9],[-23,-46,4.4,0.7],
  [-23,-58,5.1,2.3],[-33,-56,3.9,1.0],[-25,-65,4.6,3.2],[-38,-68,3.4,0.3],[-30,-71,5.0,1.8],
  [-16,-68,4.3,2.7],[-2,-78,3.7,1.5],[10,-63,4.9,3.4],[6,-58,4.0,0.6],[-5,-35,5.2,2.1],
  // Australia & Oceania
  [-28,122,5.1,1.3],[-17,133,3.8,3.0],[-24,133,4.4,0.8],[-34,146,5.6,2.5],[-37,145,4.0,1.1],
  [-33,151,3.5,3.7],[-31,116,4.8,0.2],[-20,119,5.3,2.0],[-12,131,3.7,1.6],[-27,153,4.2,3.3],
  [-37,175,4.0,0.9],[-36,174,5.1,2.4],[-43,172,3.6,1.0],[-18,178,3.9,3.6],[-8,160,4.7,0.5],
  [-6,147,5.4,2.2],[-9,147,4.1,1.4],[-4,152,3.5,3.8],[21,157,4.9,0.7],[14,121,4.3,1.9],
]
...
function GlobeViz() {
  ...
  const dots = RAW_COUNTRIES.map(([lat, lon, dur, delay], i) => {
    const p = proj(lat, lon, ry)
    return p.z > 0 ? { ...p, dur, delay, i } : null
  ...
  return (
    <svg viewBox="0 0 400 400"
      ...
      {dots.map(d => (
        <circle key={`c-${d.i}`}
          cx={d.svgX} cy={d.svgY} r="0.7" fill="white"
          opacity={0.2 + d.z * 0.8}
